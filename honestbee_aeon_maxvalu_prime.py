...
driver.get('https://www.honestbee.my/en/groceries/stores/aeon_maxvalu')
...
data.to_csv('honestbee_aeon_maxvalu_prime_category.csv',index=False)
...
item_df.to_csv('20180918_honestbee_aeon_maxvalu_prime_database.csv',index=False)
item_df.head()