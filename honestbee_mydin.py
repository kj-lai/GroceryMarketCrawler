...
driver.get('https://www.honestbee.my/en/groceries/stores/mydin')
...
data.to_csv('honestbee_mydin_category.csv',index=False)
...
item_df.to_csv('20180918_honestbee_mydin_database.csv',index=False)
item_df.head()